...
Start a terminal and navigate to the directory of the downloaded/ cloned materials. For example, if the materials now live in the directory `/Users/knaaptime/Downloads/pysal-iale2022` , you need to navigate to that directory from the terminal (using command `cd` ):
